...
Route::middleware([
    'auth:sanctum',
    config('jetstream.auth_session'),'verified','auth'])->group(function () {
        
        Route::get('/dashboard', [SimpleUserController::class,"index"])->name('dashboard');
        
        Route::get('/create-new-post',   [SimpleUserController::class,"create"]  )->name("create-new-post");
        Route::post('/store-new-post',    [SimpleUserController::class,"store"]   )->name("store-new-post");
